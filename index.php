...
<body>
	...
	<div id="heroCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<!-- Slide 1 -->
			<div class="carousel-item active hero-wrap js-fullheight" style="background-image: url('images/tt.jpg');"
			...
			<!-- Slide 2 -->
			<div class="carousel-item hero-wrap js-fullheight" style="background-image: url('images/tt.jpg');"
				data-stellar-background-ratio="0.5">
				<div class="overlay"></div>
				<div class="hero-wrap js-fullheight" data-stellar-background-ratio="0.5">
					<div class="container">
			...
			<div class="row d-md-flex justify-content-center">
				<div class="col-md-12">
					<div class="wrap-appointment bg-white d-md-flex pl-md-4 pb-5 pb-md-0">
						<form action="" method="post" class="appointment w-100">
							<div class="row justify-content-center">
										...
										<div class="form-field">
											<div class="select-wrap">
												...
												<select name="service" id="service" class="form-control">
													...
													<option value="Residence Cleaning">Residence Cleaning</option>
								...
								<div class="col-12 col-md d-flex align-items-center align-items-stretch">
									<div
										...
										<input type="submit" name="submitAppointment" value="Make an Appointment"
						...
						if (isset($_POST['submitAppointment'])) {
							...
							if ($_SERVER["REQUEST_METHOD"] == "POST") {
								...
								$mail->Subject = "Appointment for Gleaming Service";
								$content = "Name: $name<br>Phone: $phone<br>Service: $service<br>";
						...
						<div class="time-open-wrap">
							<div class="desc p-4">
								...
								<div class="opening-hours">
									<h4>Opening Days:</h4>
									<p class="pl-3">
										<span><strong>Monday – Friday:</strong> 8am to 7 pm</span>
										<span><strong>Sunday :</strong> 9am to 5 pm</span>
									</p>
							...
							<div class="desc p-4 bg-secondary">
								...
								<span class="phone">+91 9108763869</span>
							</div>
						</div>
					</div>
				</div>
				<div class="col-md-6 pl-md-5 pt-md-5">
					<div class="row justify-content-start py-5">
						<div class="col-md-12 heading-section ftco-animate">
							<span class="subheading">Welcome to Gleaming</span>
							<h2 class="mb-4">Spotlesss Cleaning at Your DoorStep</h2>
							<p>We specialize in residential, commercial, and industrial cleaning services, delivering
								exceptional results with eco-friendly products and attention to detail. Whether it's
								your home, office, or facility, we offer reliable, affordable cleaning solutions to keep
								your space spotless. Contact us today.</p>
						</div>
					</div>
					<div class="row ftco-counter py-5" id="section-counter">
						<div class="col-md-6 col-lg-4 d-flex justify-content-center counter-wrap ftco-animate">
							<div class="block-18">
								<div class="text">
									<strong class="number" data-number="02">0</strong>
								</div>
								<div class="text">
						...
						<div class="col-md-6 col-lg-4 d-flex justify-content-center counter-wrap ftco-animate">
							<div class="block-18">
								...
								<div class="text">
									<span>Buildings <br>Cleaned</span>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-md-6 col-lg-4 services ftco-animate">
					<div class="d-block d-flex">
						...
						<div class="media-body pl-3">
							...
							<p> Our professional office cleaning services provide reliable, eco-friendly solutions for a
								clean, organized, and productive workspace.</p>
				...
				<div class="col-md-6 col-lg-4 services ftco-animate">
					<div class="d-block d-flex">
						...
						<div class="media-body pl-3">
							<h3 class="heading">Matress Cleaning</h3>
							<p>Refresh your mattress with our deep cleaning services, removing dirt, allergens, and
								stains for a healthier sleep.</p>
							<p><a href="#" class="btn-custom">Read more</a></p>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-lg-4 services ftco-animate">
					<div class="d-block d-flex">
						...
						<div class="media-body pl-3">
							...
							<p>Revitalize your carpets with our expert cleaning services, removing stains and odors for
								a fresh, spotless home.</p>
							<p><a href="#" class="btn-custom">Read more</a></p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-4 services ftco-animate">
					<div class="d-block d-flex">
						...
						<div class="media-body pl-3">
							<h3 class="heading">Sofa Cleaning</h3>
							<p>Restore your sofa’s freshness with our professional cleaning services, removing stains,
								odors, and dirt for comfort.</p>
							<p><a href="#" class="btn-custom">Read more</a></p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-4 services ftco-animate">
					<div class="d-block d-flex">
						...
						<div class="media-body pl-3">
							<h3 class="heading">Office Deep Cleaning</h3>
							<p>Our office deep cleaning service ensures a thorough, hygienic space, improving
								cleanliness and creating a healthier work environment.
				...
				<div class="col-md-6 col-lg-4 services ftco-animate">
					<div class="d-block d-flex">
						...
						<div class="media-body pl-3">
							...
							<p>Our professional window cleaning services ensure streak-free, crystal-clear windows,
								enhancing your view and boosting curb appeal.</p>
							<p><a href="#" class="btn-custom">Read more</a></p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="block-7">
						<div class="text-center">
							...
							<h4 class="heading-2">Sofa Cleaning</h4>
							<span class="price"><sup></sup> <span class="number"></span></span>

							<ul class="pricing-text mb-5">
								<li><span class="fa fa-check mr-2"></span>SOFA 3 SEATER - ₹599</li>
								<li><span class="fa fa-check mr-2"></span>SOFA 4 SEATER - ₹799</li>
								<li><span class="fa fa-check mr-2"></span>SOFA 5 SEATER - ₹999</li>
								<li><span class="fa fa-check mr-2"></span>SOFA 10 SEATER - ₹1699</li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="block-7 active">
						<div class="text-center">
							...
							<h4 class="heading-2">CARPET DEEP CLEAN</h4>
							<span class="price"><sup></sup> <span class="number"></span></span>

							<ul class="pricing-text mb-5">
								<li><span class="fa fa-check mr-2"></span>CARPET 24 Sq. Ft. - ₹599</li>
								<li><span class="fa fa-check mr-2"></span>CARPET 25 to 40 Sq. Ft. - ₹749</li>
								<li><span class="fa fa-check mr-2"></span>CARPET 40 to 70 Sq. Ft. - ₹999</li>
								<li><span class="fa fa-check mr-2"></span>CARPET 70 to 100 Sq. Ft. - ₹1099</li>
				...
				<div class="col-md-6 col-lg-3 ftco-animate">
					<div class="block-7">
						<div class="text-center">
							...
							<h4 class="heading-2">OFFICE DEEP CLEANING</h4>


							<ul class="pricing-text mb-5">
								<li><span class="fa fa-check mr-2"></span>FLOOR CLEANING Sq. Ft - ₹3</li>
								<li><span class="fa fa-check mr-2"></span>BATHROOM CLEANING - ₹3000</li>
								<li><span class="fa fa-check mr-2"></span>DUSTING - ₹999</li>
								<li><span class="fa fa-check mr-2"></span>GLASS CLEANING - ₹299</li>
							</ul>
